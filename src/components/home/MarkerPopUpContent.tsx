...
const MarkerPopUpContent = ({ lottoData }: { lottoData: LottoDataType }) => {
  useEffect(() => {
  ...
  return (
    <PopUpContentDetailStyle>
      ...
      <div>
        ...
        <span className="addrSpan">{lottoData.address}</span>
      </div>
      <div style={{ margin: '0.8rem 0' }}>
        ...
        <span className="phone">{lottoData.phone}</span>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
        <span className="first_prize">
          ...
          : <span id="num">{lottoData.first_prize}</span>
        ...
        <span className="second_prize">
          ...
          : <span id="num">{lottoData.second_prize}</span>
          <span style={{ fontSize: '0.85rem', fontWeight: 'medium' }}>번</span>
        </span>
      </div>
    </PopUpContentDetailStyle>
